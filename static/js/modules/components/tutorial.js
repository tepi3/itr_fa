...
export function showTutorialStepByTitle(title) {
    ...
    if (!foundStep) {
        const customSteps = {
            ...
            "dividends": { selector: "#assetPieChartSection", title: "Per-Stock Summary", desc: "Per-Stock Summary next to the Asset Chart displaying units, USD/INR value, dividends, unrealized G/L, and overall XIRR for each stock." },
            "per-stock summary": { selector: "#assetPieChartSection", title: "Per-Stock Summary", desc: "Per-Stock Summary next to the Asset Chart displaying units, USD/INR value, dividends, unrealized G/L, and overall XIRR for each stock." },
