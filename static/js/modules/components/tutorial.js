...
export function showTutorialStepByTitle(title) {
    ...
    if (!foundStep) {
        const customSteps = {
            ...
            "dividends": { selector: "#stockSummarySection", title: "Per-Stock Summary", desc: "Per-Stock Summary displaying total dividends earned, unrealized G/L, and overall XIRR for the calendar year." },
            "per-stock summary": { selector: "#stockSummarySection", title: "Per-Stock Summary", desc: "Per-Stock Summary displaying total dividends earned, unrealized G/L, and overall XIRR for the calendar year." },
